...
class BaseTrainer(object):
    def __init__(self, model, criterion, X, Y, SMLoss_mode=0, output_dir=None):
    ...
    def train(self, epoch, data_loader, optimizer, print_freq=1):
        ...
        for i, inputs in enumerate(data_loader):
            ...
            loss0, loss1, loss2, loss3, loss4, loss5, loss6, loss_layer1, loss_layer2, loss_layer3, prec1 = self._forward(
                inputs, targets)
            # ===================================================================================
            ...
            # write('loss.log',
            #       'epoch:' + str(epoch) + '   loss_avg:' + str(losses.avg) + '    loss_val:' + str(losses.val) + '\r')
            # plot progress
